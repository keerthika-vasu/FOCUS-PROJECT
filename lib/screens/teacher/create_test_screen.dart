...
class _CreateTestScreenState extends State<CreateTestScreen> {
  ...
  Future<void> _save() async {
    if (_titleCtrl.text.trim().isEmpty) {
      _snack('Please enter a test title.', AppColors.danger);
      return;
    }
    final questions = <Map<String, dynamic>>[];
    for (final q in _questions) {
      if (q.questionCtrl.text.trim().isEmpty) continue;
      questions.add({
    ...
    if (questions.isEmpty) {
      _snack('Add at least one question.', AppColors.danger);
      return;
    }
    setState(() => _saving = true);
    try {
      await ApiService.createTest(
          _titleCtrl.text.trim(), Session.userId, questions);
      if (!mounted) return;
      _snack('Test created successfully!', AppColors.success);
    ...
    return Scaffold(
                    ...
                    children: [
                      ...
                      ...List.generate(4, (j) {
                        ...
                        return Padding(
                          ...
                          child: Row(children: [
                            GestureDetector(
                              onTap: () => setState(() => q.correctIndex = j),
                              child: Icon(
                                  correct
                            ...
                            Expanded(
                                child: _innerField(q.optionCtrls[j],
      ...
      bottomSheet: Container(
        ...
        child: _saving
            ...
            : PrimaryButton(
                label: 'Save Test', icon: Icons.save_rounded, onPressed: _save),
      ),
    );
  }
